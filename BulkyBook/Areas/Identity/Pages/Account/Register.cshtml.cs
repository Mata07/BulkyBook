...
namespace BulkyBook.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        //add RoleManager and UOW
        // configure services for RoleManager in Startup.cs
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            // Add dropdowns for Admins to register Users
            Input = new InputModel()
            {
                ...
                // Admins should not register Individual User so don't display in Roles dorpdown (Where clause)
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // Add new user of ApplicationUser type
            ...
            // Repopulate dropdowns if something failed
            Input = new InputModel()
            {
                CompanyList = _unitOfWork.Company.GetAll().Select(i => new SelectListItem
                {
